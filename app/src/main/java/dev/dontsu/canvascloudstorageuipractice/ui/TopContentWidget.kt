...
import dev.dontsu.canvascloudstorageuipractice.R
import dev.dontsu.canvascloudstorageuipractice.Utils
import dev.dontsu.canvascloudstorageuipractice.ui.theme.DarkBlue
import dev.dontsu.canvascloudstorageuipractice.ui.theme.Orange
        ...
        modifier = Modifier
            ...
            .pointerInput(pointerInputKey) {
                awaitPointerEventScope {
                    ...
                    // requireUnconsumed = true로 하면 터치 이벤트가 아직 소비되지 않은 경우
                    // 다음에 들어오는 터치이벤트를 무시한다.
                    // true인 경우에는 모든 터치 이벤트를 감지한다. 정확한 제어가 필요한 경우에는 true로 할 수 있다.
